...
public class updatePatient extends javax.swing.JFrame {
    ...
    public updatePatient() {
        ...
        Object columns[] = {"Serial no", "Date", "Id", "Name", "Age", "Gender", "Address", "Phone Number", "Disease", "Room Number"};
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();
        String sql = "Update patient set date = '" + date + "', id = '" + id + "', name = '" + name + "', age = '" + age + "', gender = '" + gender + "', address = '" + address + "', phone = '" + phone +  "', disease = '" + disease + "', room = '" + room + "' where count = '" + count + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
