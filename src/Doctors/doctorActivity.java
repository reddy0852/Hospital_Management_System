...
public class doctorActivity extends javax.swing.JFrame {
    ...
    public doctorActivity(String pdName) {
        initComponents();
        ImageIcon ic = new ImageIcon(getClass().getResource("/Images/hospital.png"));
        this.setIconImage(ic.getImage());
        findName = pdName;
       // findName ="Sifat Islam";
    }
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
       /* connection = Connector.ConnectDb();
        ...
        connection = Connector.ConnectDb();
        String sql = " select doc_name from doctor where username='" + findName + "'";
        
            try {
                ps = connection.prepareStatement(sql);
                rs = ps.executeQuery();
                rs.first();
                String getPname = rs.getString("doc_name");
                patientDetails pDetails = new patientDetails(getPname);
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
       /* connection = Connector.ConnectDb();
        ...
        try {
           ...
           // appointment.setVisible(true);
            patientDetails pDetails = new patientDetails(findName);
            pDetails.setVisible(true);
            dispose();
        //    dispose();
