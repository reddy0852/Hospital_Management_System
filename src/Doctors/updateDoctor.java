...
public class updateDoctor extends javax.swing.JFrame {
    ...
    public updateDoctor() {
        ...
        Object columns[] = {"Serial", "Joining Date", "Id", "Name", "Age", "Gender", "Blood Group", "Department", "Phone Number", "Email Address", "Address", "Room number", "Username", "Password"};
    ...
    public void loadData() {
        ...
        String sql = "select count,date,doc_id,doc_name,age,gender,blood,dept,phone,email,address,room,username,password from doctor";
        try {
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();
        String sql = "Update doctor set date = '" + date + "', doc_id = '" + id + "', doc_name = '" + name + "', age = '" + age + "', gender = '" + gender + "', blood = '" + blood + "', dept = '" + dept + "', phone = '" + phone + "', email = '" + email + "',  address = '" + address + "', room = '" + room + "', username = '" + username + "', password = '" + password + "' where doc_id = '" + count + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.executeUpdate();
