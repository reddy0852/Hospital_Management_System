...
public class viewReceptionist extends javax.swing.JFrame {
    ...
    public viewReceptionist() {
        ...
        Object columns[] = {"Serial", "Joining Date", "Id", "Name", "Age", "Gender", "Blood Group", "Email Address", "Phone Number", "Address", "Username", "Password"};
    ...
    public final void loadData() {
        ...
        String sql = "select count,joining,rec_id,rec_name,age,gender,blood,email,phone,address,username from receptionist";
        try {
    ...
    private void initComponents() {
        ...
        rTable.setBackground(new java.awt.Color(204, 255, 204));
        ...
        if (rTable.getColumnModel().getColumnCount() > 0) {
            rTable.getColumnModel().getColumn(0).setHeaderValue("Title 1");
            rTable.getColumnModel().getColumn(1).setHeaderValue("Title 2");
            rTable.getColumnModel().getColumn(2).setHeaderValue("Title 3");
            rTable.getColumnModel().getColumn(3).setHeaderValue("Title 4");
        }
