...
public class patientManagement extends javax.swing.JFrame {
  ...
  //  String status;
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        connection = Connector.ConnectDb();
        String sql = "Update patient set date = '" + date + "', pat_id = '" + id + "', pat_name = '" + name + "', pat_age = '" + age + "', gender = '" + gender + "', address = '" + address + "', phone = '" + phone + "', disease = '" + disease + "', room = '" + room + "' where count = '" + count + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            defaultTableModel.getDataVector().removeAllElements();
