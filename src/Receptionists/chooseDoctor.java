...
public class chooseDoctor extends javax.swing.JFrame {
    ...
    public static int room12;
    public static String name12;
    public chooseDoctor() {
        initComponents();
        ImageIcon ic = new ImageIcon(getClass().getResource("/Images/hospital.png"));
        this.setIconImage(ic.getImage());
        Object columns[] = {"Serial", "Joining Date", "Id", "Name", "Age", "Gender", "Blood Group", "Department", "Phone Number", "Email Address", "Address", "Room number", "Username"};
    ...
    private void initComponents() {
        ...
        jLabel12.setFont(new java.awt.Font("Goudy Old Style", 0, 24)); // NOI18N
        ...
        apTable.setBackground(new java.awt.Color(204, 255, 204));
        apTable.setFont(new java.awt.Font("Segoe UI Emoji", 2, 12)); // NOI18N
        apTable.setForeground(new java.awt.Color(51, 51, 51));
        ...
        jSearchbutton.setBackground(new java.awt.Color(204, 204, 255));
        ...
        jLabel3.setText("Select one doctor from the above list");

        jLabel4.setText("Enter doctor_id");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jpage, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(485, 485, 485))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(112, 112, 112)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(55, 55, 55)
                        .addComponent(doctorhind, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jSearchbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(122, 122, 122)
                        .addComponent(jpage, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
    ...
    private void jSearchbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSearchbuttonActionPerformed
        ...
        String sql = "select count,date,doc_id,doc_name,age,gender,blood,dept,phone,email,address,room,username from doctor where dept = '" + searchKey + "'";
        try {
            ...
            while (rs.next()) {
                ...
                columnData[2] = rs.getString("doc_id");
                columnData[3] = rs.getString("doc_name");
    ...
    public void load1(){
        ...
        // String searchKey = (String) dSearchbox.getSelectedItem();
         ...
         String sql = "SELECT doc_name,room FROM doctor where doc_id = '" + id + "'" ;
    ...
    private javax.swing.JButton jpage;
